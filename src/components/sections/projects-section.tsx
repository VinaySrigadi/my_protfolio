    ...
    <Section id="projects" spacing="lg">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        ...
        <MagneticButton strength={0.2} className="shrink-0 hidden md:flex">
          <Link
            href="/projects"
            className={cn(
              "inline-flex items-center gap-2 rounded-full border border-border bg-muted/30 px-6 py-2.5",
              "text-sm font-medium text-foreground transition-colors",
              "hover:bg-muted/50 hover:border-border/80 hover:text-primary",
      ...
      <div className="mt-8 flex justify-center md:hidden">
        <Link
          href="/projects"
          className={cn(
            "inline-flex w-full justify-center items-center gap-2 rounded-lg border border-border bg-muted/30 px-6 py-3",
            "text-sm font-medium text-foreground transition-colors hover:bg-muted/50 hover:border-border/80 hover:text-primary",
            "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          )}
        >
          View all projects
